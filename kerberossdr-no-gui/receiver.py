...
class ReceiverRTLSDR():
    ...
    def __init__(self):
            ...
            self.gc_fifo_name = "_receiver/gate_control_fifo"
            self.sync_fifo_name = "_receiver/sync_control_fifo"
            self.rec_control_fifo_name = "_receiver/rec_control_fifo"
            ...
            self.block_size = 256*1024; #128 * 1024 #256*1024
